...
from segm.seg_utils import Visualizer
...
def inference_sam_m2m_auto(model, image, dest_path, text_size=1080, label_mode='1', alpha=0.1, anno_mode=['Mask',], save=True):
    t = []
    ...
    for i, ann in enumerate(sorted_anns):
        ...
        demo, _coord = visual.draw_binary_mask_with_number(mask, text=str(label), label_mode=label_mode, alpha=alpha, anno_mode=anno_mode)
        x, y = _coord
        mapping[label] = (y, x)
