...
class Visualizer:
    ...
    def draw_rotated_box_with_label(
        ...
        if label is not None:
            ...
            font_size = (
                np.clip((height_ratio - 0.02) / 0.08 + 1, 0.5, 2) * 0.5 * self._default_font_size/4
            )
    ...
    def draw_binary_mask_with_number(
        ...
        if text is not None and has_valid_segment:
            ...
            coord = self._draw_number_in_mask(binary_mask, text, lighter_color, label_mode)
        return self.output, coord
    ...
    def _draw_number_in_mask(self, binary_mask, text, color, label_mode='1'):
        ...
        self.draw_text(text, (coords_x[len(coords_x)//2] + 2, coords_y[len(coords_y)//2] - 6 - 20), color=color)
